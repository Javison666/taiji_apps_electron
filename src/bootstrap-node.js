...
function setupCurrentWorkingDirectory() {
	...
	try {
		...
		// a parent process.
		if (typeof process.env['CLIENT_CWD'] !== 'string') {
			process.env['CLIENT_CWD'] = process.cwd();
		}
...
exports.configurePortable = function (product) {
	...
	function getPortableDataPath(path) {
		if (process.env['CLIENT_PORTABLE']) {
			return process.env['CLIENT_PORTABLE'];
		}
	...
	if (isPortable) {
		process.env['CLIENT_PORTABLE'] = portableDataPath;
	} else {
		delete process.env['CLIENT_PORTABLE'];
	}
