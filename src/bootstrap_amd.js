...
const loader = require('./client/loader');
const bootstrap = require('./bootstrap');
const performance = require('./client/base/common/performance');
...
exports.load = function (entrypoint, onLoad, onError) {
	...
	// code cache config
	if (process.env['CLIENT_CODE_CACHE_PATH']) {
		loader.config({
			nodeCachedData: {
				path: process.env['CLIENT_CODE_CACHE_PATH'],
				seed: entrypoint
			}
		});
	}
